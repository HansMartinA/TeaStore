...
public static final int SIZE = TYPE_SIZE_STRING + TYPE_SIZE_STRING + TYPE_SIZE_LONG + TYPE_SIZE_LONG + TYPE_SIZE_LONG + TYPE_SIZE_STRING + TYPE_SIZE_INT + TYPE_SIZE_INT + TYPE_SIZE_STRING + TYPE_SIZE_STRING + TYPE_SIZE_STRING + TYPE_SIZE_STRING;

public static final Class<?>[]  TYPES = {String.class, String.class, long.class, long.class, long.class, String.class, int.class, int.class, String[] .class, String[] .class, String.class, String.class};
