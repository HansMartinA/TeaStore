...
threadMonitoringController.enterService("_LkLxMAskEeyH6q2UaRYLeA", this, monitoringServiceParameters);
try {
threadMonitoringController.enterInternalAction("_LkMYQAskEeyH6q2UaRYLeA", "_oro4gG3fEdy4YaaT-RYrLQ");
if (productId == null)
{
...
List<OrderItem> longAndUniqueNameToAvoidDuplicationsAndCompilationErrors1630501185475009436351474492634 = orderItems;
threadMonitoringController.exitInternalAction("_LkMYQAskEeyH6q2UaRYLeA", "_oro4gG3fEdy4YaaT-RYrLQ");
return longAndUniqueNameToAvoidDuplicationsAndCompilationErrors1630501185475009436351474492634;
}
finally {
threadMonitoringController.exitService("_LkLxMAskEeyH6q2UaRYLeA");
}
}
...
monitoringServiceParameters.addValue("startPosition", startPosition);
monitoringServiceParameters.addValue("maxResult", maxResult);
threadMonitoringController.enterService("_LkRQwQskEeyH6q2UaRYLeA", this, monitoringServiceParameters);
try {
threadMonitoringController.enterInternalAction("_LkR30AskEeyH6q2UaRYLeA", "_oro4gG3fEdy4YaaT-RYrLQ");
if (orderId == null)
{
return listAll(startPosition, maxResult);
}
...
List<OrderItem> longAndUniqueNameToAvoidDuplicationsAndCompilationErrors1630501185476008338849880665401 = orderItems;
threadMonitoringController.exitInternalAction("_LkR30AskEeyH6q2UaRYLeA", "_oro4gG3fEdy4YaaT-RYrLQ");
return longAndUniqueNameToAvoidDuplicationsAndCompilationErrors1630501185476008338849880665401;
}
finally {
threadMonitoringController.exitService("_LkRQwQskEeyH6q2UaRYLeA");
}
}
