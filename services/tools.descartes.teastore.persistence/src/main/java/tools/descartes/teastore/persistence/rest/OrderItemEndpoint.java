...
threadMonitoringController.enterService("_8mgQcQd_Eeyp7eds7yI7tA", this, monitoringServiceParameters);
try {
threadMonitoringController.enterInternalAction("_8mg3gAd_Eeyp7eds7yI7tA", "_oro4gG3fEdy4YaaT-RYrLQ");
if (productId == null)
{
...
List<OrderItem> longAndUniqueNameToAvoidDuplicationsAndCompilationErrors1630100789260006010044416960478 = orderItems;
threadMonitoringController.exitInternalAction("_8mg3gAd_Eeyp7eds7yI7tA", "_oro4gG3fEdy4YaaT-RYrLQ");
return longAndUniqueNameToAvoidDuplicationsAndCompilationErrors1630100789260006010044416960478;
}
finally {
threadMonitoringController.exitService("_8mgQcQd_Eeyp7eds7yI7tA");
}
}
...
monitoringServiceParameters.addValue("startPosition", startPosition);
monitoringServiceParameters.addValue("maxResult", maxResult);
threadMonitoringController.enterService("_8mmXEAd_Eeyp7eds7yI7tA", this, monitoringServiceParameters);
try {
threadMonitoringController.enterInternalAction("_8mmXEQd_Eeyp7eds7yI7tA", "_oro4gG3fEdy4YaaT-RYrLQ");
if (orderId == null)
{
return listAll(startPosition, maxResult);
}
...
List<OrderItem> longAndUniqueNameToAvoidDuplicationsAndCompilationErrors16301007892610047373386856231825 = orderItems;
threadMonitoringController.exitInternalAction("_8mmXEQd_Eeyp7eds7yI7tA", "_oro4gG3fEdy4YaaT-RYrLQ");
return longAndUniqueNameToAvoidDuplicationsAndCompilationErrors16301007892610047373386856231825;
}
finally {
threadMonitoringController.exitService("_8mmXEAd_Eeyp7eds7yI7tA");
}
}
