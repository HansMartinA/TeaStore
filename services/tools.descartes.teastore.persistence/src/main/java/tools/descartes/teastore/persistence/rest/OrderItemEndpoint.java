...
threadMonitoringController.enterService("_qC5DcAsxEey1ZNZ-8Luqpw", this, monitoringServiceParameters);
try {
threadMonitoringController.enterInternalAction("_qC5qgAsxEey1ZNZ-8Luqpw", "_oro4gG3fEdy4YaaT-RYrLQ");
if (productId == null)
{
...
List<OrderItem> longAndUniqueNameToAvoidDuplicationsAndCompilationErrors1630506949307003763706505430717 = orderItems;
threadMonitoringController.exitInternalAction("_qC5qgAsxEey1ZNZ-8Luqpw", "_oro4gG3fEdy4YaaT-RYrLQ");
return longAndUniqueNameToAvoidDuplicationsAndCompilationErrors1630506949307003763706505430717;
}
finally {
threadMonitoringController.exitService("_qC5DcAsxEey1ZNZ-8Luqpw");
}
}
...
monitoringServiceParameters.addValue("startPosition", startPosition);
monitoringServiceParameters.addValue("maxResult", maxResult);
threadMonitoringController.enterService("_qC-jAQsxEey1ZNZ-8Luqpw", this, monitoringServiceParameters);
try {
threadMonitoringController.enterInternalAction("_qC_KEAsxEey1ZNZ-8Luqpw", "_oro4gG3fEdy4YaaT-RYrLQ");
if (orderId == null)
{
return listAll(startPosition, maxResult);
}
...
List<OrderItem> longAndUniqueNameToAvoidDuplicationsAndCompilationErrors1630506949308007818285506893672 = orderItems;
threadMonitoringController.exitInternalAction("_qC_KEAsxEey1ZNZ-8Luqpw", "_oro4gG3fEdy4YaaT-RYrLQ");
return longAndUniqueNameToAvoidDuplicationsAndCompilationErrors1630506949308007818285506893672;
}
finally {
threadMonitoringController.exitService("_qC-jAQsxEey1ZNZ-8Luqpw");
}
}
