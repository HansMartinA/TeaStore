...
try {
threadMonitoringController.enterInternalAction("_UfllIA3FEeyW9oGRo1qexg", "_oro4gG3fEdy4YaaT-RYrLQ");
if (name == null || name.isEmpty())
{
Response longAndUniqueNameToAvoidDuplicationsAndCompilationErrors1630790182723008018346976947126 = Response.status(Status.NOT_FOUND).build();
threadMonitoringController.exitInternalAction("_UfllIA3FEeyW9oGRo1qexg", "_oro4gG3fEdy4YaaT-RYrLQ");
return longAndUniqueNameToAvoidDuplicationsAndCompilationErrors1630790182723008018346976947126;
}
threadMonitoringController.enterInternalAction("_UfvWIA3FEeyW9oGRo1qexg", "_oro4gG3fEdy4YaaT-RYrLQ");
User entity = UserRepository.REPOSITORY.getUserByName(name);
threadMonitoringController.exitInternalAction("_UfvWIA3FEeyW9oGRo1qexg", "_oro4gG3fEdy4YaaT-RYrLQ");
threadMonitoringController.enterInternalAction("_UfwkQA3FEeyW9oGRo1qexg", "_oro4gG3fEdy4YaaT-RYrLQ");
if (entity == null)
{
return Response.status(Status.NOT_FOUND).build();
}
Response longAndUniqueNameToAvoidDuplicationsAndCompilationErrors1630790182723009596647900467046 = Response.ok(new  User(entity)).build();
threadMonitoringController.exitInternalAction("_UfwkQA3FEeyW9oGRo1qexg", "_oro4gG3fEdy4YaaT-RYrLQ");
return longAndUniqueNameToAvoidDuplicationsAndCompilationErrors1630790182723009596647900467046;
}
finally {
