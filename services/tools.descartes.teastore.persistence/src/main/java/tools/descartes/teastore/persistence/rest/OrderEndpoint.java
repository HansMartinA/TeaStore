...
threadMonitoringController.enterService("_3l_u8PhgEeudoMIzjEj1xQ", this, monitoringServiceParameters);
try {
threadMonitoringController.enterInternalAction("_3nEF8PhgEeudoMIzjEj1xQ", "_oro4gG3fEdy4YaaT-RYrLQ");
if (userId == null)
{
...
List<Order> longAndUniqueNameToAvoidDuplicationsAndCompilationErrors16470086662980045327405486535044 = orders;
threadMonitoringController.exitInternalAction("_3nEF8PhgEeudoMIzjEj1xQ", "_oro4gG3fEdy4YaaT-RYrLQ");
return longAndUniqueNameToAvoidDuplicationsAndCompilationErrors16470086662980045327405486535044;
}
finally {
threadMonitoringController.exitService("_3l_u8PhgEeudoMIzjEj1xQ");
}
}
