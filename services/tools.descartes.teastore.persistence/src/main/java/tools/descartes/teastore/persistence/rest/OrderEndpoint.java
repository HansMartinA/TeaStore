...
threadMonitoringController.enterService("_8mQY0Ad_Eeyp7eds7yI7tA", this, monitoringServiceParameters);
try {
threadMonitoringController.enterInternalAction("_8mQ_4Ad_Eeyp7eds7yI7tA", "_oro4gG3fEdy4YaaT-RYrLQ");
if (userId == null)
{
...
List<Order> longAndUniqueNameToAvoidDuplicationsAndCompilationErrors1630100789258008407433253486523 = orders;
threadMonitoringController.exitInternalAction("_8mQ_4Ad_Eeyp7eds7yI7tA", "_oro4gG3fEdy4YaaT-RYrLQ");
return longAndUniqueNameToAvoidDuplicationsAndCompilationErrors1630100789258008407433253486523;
}
finally {
threadMonitoringController.exitService("_8mQY0Ad_Eeyp7eds7yI7tA");
}
}
