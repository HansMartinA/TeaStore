...
threadMonitoringController.enterService("_Lj75kAskEeyH6q2UaRYLeA", this, monitoringServiceParameters);
try {
threadMonitoringController.enterInternalAction("_Lj8goAskEeyH6q2UaRYLeA", "_oro4gG3fEdy4YaaT-RYrLQ");
if (userId == null)
{
...
List<Order> longAndUniqueNameToAvoidDuplicationsAndCompilationErrors1630501185475005147398829320984 = orders;
threadMonitoringController.exitInternalAction("_Lj8goAskEeyH6q2UaRYLeA", "_oro4gG3fEdy4YaaT-RYrLQ");
return longAndUniqueNameToAvoidDuplicationsAndCompilationErrors1630501185475005147398829320984;
}
finally {
threadMonitoringController.exitService("_Lj75kAskEeyH6q2UaRYLeA");
}
}
