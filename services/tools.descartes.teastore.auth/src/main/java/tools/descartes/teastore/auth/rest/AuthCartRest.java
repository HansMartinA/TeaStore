...
try {
threadMonitoringController.enterInternalAction("_QYPwQPkUEeuv6O-Z3paUUA", "_oro4gG3fEdy4YaaT-RYrLQ");
Product product;
try {
...
threadMonitoringController.exitInternalAction("_QYPwQPkUEeuv6O-Z3paUUA", "_oro4gG3fEdy4YaaT-RYrLQ");
threadMonitoringController.enterInternalAction("_QYV25PkUEeuv6O-Z3paUUA", "_oro4gG3fEdy4YaaT-RYrLQ");
blob = new  ShaSecurityProvider().secure(blob);
threadMonitoringController.exitInternalAction("_QYV25PkUEeuv6O-Z3paUUA", "_oro4gG3fEdy4YaaT-RYrLQ");
threadMonitoringController.enterInternalAction("_QYWd8PkUEeuv6O-Z3paUUA", "_oro4gG3fEdy4YaaT-RYrLQ");
Response longAndUniqueNameToAvoidDuplicationsAndCompilationErrors16472016826870029017443086618255 = Response.status(Response.Status.OK).entity(blob).build();
threadMonitoringController.exitInternalAction("_QYWd8PkUEeuv6O-Z3paUUA", "_oro4gG3fEdy4YaaT-RYrLQ");
return longAndUniqueNameToAvoidDuplicationsAndCompilationErrors16472016826870029017443086618255;
}
finally {
