...
try {
threadMonitoringController.enterInternalAction("_8KUB4PkUEeuv6O-Z3paUUA", "_oro4gG3fEdy4YaaT-RYrLQ");
Product product;
try {
...
threadMonitoringController.exitInternalAction("_8KUB4PkUEeuv6O-Z3paUUA", "_oro4gG3fEdy4YaaT-RYrLQ");
threadMonitoringController.enterInternalAction("_8KaIhPkUEeuv6O-Z3paUUA", "_oro4gG3fEdy4YaaT-RYrLQ");
blob = new  ShaSecurityProvider().secure(blob);
threadMonitoringController.exitInternalAction("_8KaIhPkUEeuv6O-Z3paUUA", "_oro4gG3fEdy4YaaT-RYrLQ");
threadMonitoringController.enterInternalAction("_8KavkPkUEeuv6O-Z3paUUA", "_oro4gG3fEdy4YaaT-RYrLQ");
Response longAndUniqueNameToAvoidDuplicationsAndCompilationErrors1647202323067009854300101216225 = Response.status(Response.Status.OK).entity(blob).build();
threadMonitoringController.exitInternalAction("_8KavkPkUEeuv6O-Z3paUUA", "_oro4gG3fEdy4YaaT-RYrLQ");
return longAndUniqueNameToAvoidDuplicationsAndCompilationErrors1647202323067009854300101216225;
}
finally {
