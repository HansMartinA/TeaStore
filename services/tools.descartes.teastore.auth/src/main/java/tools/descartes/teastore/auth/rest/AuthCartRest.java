...
try {
threadMonitoringController.enterInternalAction("_yIJIsPhsEeuIqOQIQEQ0aQ", "_oro4gG3fEdy4YaaT-RYrLQ");
Product product;
try {
...
threadMonitoringController.exitInternalAction("_yIJIsPhsEeuIqOQIQEQ0aQ", "_oro4gG3fEdy4YaaT-RYrLQ");
threadMonitoringController.enterInternalAction("_yIa1g_hsEeuIqOQIQEQ0aQ", "_oro4gG3fEdy4YaaT-RYrLQ");
blob = new  ShaSecurityProvider().secure(blob);
threadMonitoringController.exitInternalAction("_yIa1g_hsEeuIqOQIQEQ0aQ", "_oro4gG3fEdy4YaaT-RYrLQ");
threadMonitoringController.enterInternalAction("_yIbckPhsEeuIqOQIQEQ0aQ", "_oro4gG3fEdy4YaaT-RYrLQ");
Response longAndUniqueNameToAvoidDuplicationsAndCompilationErrors164720343419900762080569802338 = Response.status(Response.Status.OK).entity(blob).build();
threadMonitoringController.exitInternalAction("_yIbckPhsEeuIqOQIQEQ0aQ", "_oro4gG3fEdy4YaaT-RYrLQ");
return longAndUniqueNameToAvoidDuplicationsAndCompilationErrors164720343419900762080569802338;
}
finally {
