...
try {
threadMonitoringController.enterInternalAction("_m0fwUPkTEeuv6O-Z3paUUA", "_oro4gG3fEdy4YaaT-RYrLQ");
Product product;
try {
...
threadMonitoringController.exitInternalAction("_m0fwUPkTEeuv6O-Z3paUUA", "_oro4gG3fEdy4YaaT-RYrLQ");
threadMonitoringController.enterInternalAction("_m3bIgvkTEeuv6O-Z3paUUA", "_oro4gG3fEdy4YaaT-RYrLQ");
blob = new  ShaSecurityProvider().secure(blob);
threadMonitoringController.exitInternalAction("_m3bIgvkTEeuv6O-Z3paUUA", "_oro4gG3fEdy4YaaT-RYrLQ");
threadMonitoringController.enterInternalAction("_m3c9sPkTEeuv6O-Z3paUUA", "_oro4gG3fEdy4YaaT-RYrLQ");
Response longAndUniqueNameToAvoidDuplicationsAndCompilationErrors164719685236000870395686256341 = Response.status(Response.Status.OK).entity(blob).build();
threadMonitoringController.exitInternalAction("_m3c9sPkTEeuv6O-Z3paUUA", "_oro4gG3fEdy4YaaT-RYrLQ");
return longAndUniqueNameToAvoidDuplicationsAndCompilationErrors164719685236000870395686256341;
}
finally {
